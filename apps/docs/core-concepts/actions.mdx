---
title: "Actions"
description: "Building blocks of SpinAI agents, now with enhanced formatting and duplicate execution checks"
---
...
The formatting for available actions has been enhanced to include dependencies, providing a clearer overview of each action's requirements:

```typescript
// Newly formatted action listing
{
  id: "minus",
  description: "Subtracts two numbers from each other",
...
This format helps in understanding the action's dependencies at a glance, making it easier to manage complex workflows.
